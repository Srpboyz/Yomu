...
class Source(ABC):
    ...
    def latest_request_error(self, response: Response, page: int) -> None: ...
    ...
    def search_request_error(self, response: Response, query: str) -> None: ...
    ...
    def manga_info_request_error(self, response: Response, manga: Manga) -> None: ...
    ...
    def chapter_request_error(self, response: Response, manga: Manga) -> None: ...
    ...
    def chapter_pages_request_error(
        self, response: Response, chapter: Chapter
    ) -> None: ...
    ...
    def parse_thumbnail(self, response: Response, manga: Manga) -> bytes:
        return response.read_all().data()

    def thumbnail_request_error(self, response: Response, manga: Manga) -> None: ...
    ...
    def page_request_error(self, response: Response, page: Page) -> None: ...
